      ...
      <div className="container px-6">
        <div className="blue-gradient-box rounded-3xl p-10 md:p-16 flex flex-col md:flex-row items-center gap-12 border border-primary/10">
          <div className="flex-1">
            <p className="text-primary font-semibold tracking-widest text-sm mb-4 uppercase">{t("sav_label")}</p>
            <h2 className="font-display text-6xl md:text-7xl text-primary mb-2">{t("sav_percent")}</h2>
            <h3 className="font-display text-2xl md:text-3xl mb-4 text-foreground uppercase tracking-wide">
              {t("sav_title")}
            </h3>
            <p className="text-muted-foreground mb-8 max-w-md">{t("sav_desc")}</p>
