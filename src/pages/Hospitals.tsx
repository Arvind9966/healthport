...
const HospitalDetailCard = ({ hospital, index }: { hospital: HospitalDetail; index: number }) => (
  <motion.div
    ...
    className="blue-gradient-box border border-primary/10 rounded-2xl overflow-hidden hover:shadow-xl hover:shadow-primary/5 hover:border-primary/20 transition-all duration-300 scroll-mt-32"
  >
